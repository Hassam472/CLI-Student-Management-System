...
class StudentProfile {
    ...
    batch;
    city;
    constructor(student_Name, student_Id, enroll_Course, fee_Status, currently, batch, city) {
...
if (login.Login === "New Registration") {
    ...
    class newStudent {
        student_Name = r1.NameRegister;
        student_Id = Math.floor(Math.random() * 100000 + 1);
        enroll_Course = r1.Courses;
        currently = r1.Currently;
        batch = "Batch 2";
        city = r1.Location;
        constructor() {
            this.student_Name;
